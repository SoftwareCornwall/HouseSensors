...
while True:
    ...
    sPage += paragraph("Humidity: " + str(HummidList[-1][20:25]) + "%,---" + "(Last Update: " + str(HummidList[-1][11:19]) + ")")
    sPage += paragraph("Temperature: " + str(TempList[-1][20:25]) + "&deg;C,---" + "(Last Update: " + str(TempList[-1][11:19]) + ")")
